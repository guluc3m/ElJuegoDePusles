"""
El formato de los textos va a ser:
...
#Se agacha Hermilda a por pastas

Flashback_PubConf_Hermilda_2 = u"De acuerdo, pero más le vale no faltar a su palabra, mientras quiera seguir entrando a este pub... Si es que consigo mantenerlo abierto..."
Flashback_PubConf_Pusles_3 = u"Seguro que lo consigues, mujer. Tienes un local tranquilo, ordenado... lo único que le falta es un buen puzzle."
Flashback_PubConf_Hermilda_3 = u"Pues tengo un acertijo para que resuelva: ¿Por qué iba su, oh magnánima majestad, el rey, a querer ofrecerle mi humilde establecimiento a su hija como caseta para su mascota?"

#Escupe té copiosamente

Flashback_PubConf_Pusles_4 = u"¿¡Cómorl!?"
Flashback_PubConf_Hermilda_4 = u"Como oye, mi estimado señor. El día menos pensado aparecerá la guardia real para desalojar mi local."
Flashback_PubConf_Pusles_5 = u"¡Eso es impensable! ¿Si tu local se cierra?... ¡TENDRÉ QUE IR A LA TABERNA! ¡Y AHÍ NO SIRVEN TÉ!"
Flashback_PubConf_Pusles_6 = u"... ¿cómo estará el té con cerveza?"
Flashback_PubConf_Hermilda_5 = u"Pues más vale que le guste, porque no va a tener mucha alternativa, el paladar de este pueblo no aprecia más que el orín de asno"
Flashback_PubConf_Pusles_7 = u"No puedo permitirlo, ¡iré a hablar con el rey! ¡Y haré que entre en razón!"

#castillo interior

Flashback_Castle_Pusles_1 = u"¡Majestad! Han llegado a mis oídos que pretendeis cerrar el pub de Hermilda para alojar a la mascota de la princesa Melisenda. ¿Es eso cierto, majestad?"
Flashback_Castle_King_1 = u"¿Osáis dudar de mi persona, honorable Señor Pusles? Así es, y así lo dicto yo, Rey del reino de Sapiensa. ¿Por qué su inquisitud, vasallo?"
Flashback_Castle_Pusles_2 = u"Majestad, ese local es muy importante para la riqueza cultural del reino, ya que es el único que ofrece una variedad más refinada de bebidas y alimentos. Cerrarlo supondría una gran pérdida para el reino... y para mi."
Flashback_Castle_King_2 = u"Es la Casa Real lo más refinado de este reino; es por ello que el cierre de ese establecimiento no supondrá ninguna pérdida para las gentes del lugar. Además, no hay petición que pueda negar a mi querida hija, Melisenda."
Flashback_Castle_Pusles_3 = u"Pero Majestad, privar al pueblo de ese establecimiento impedirá la posibilidad de que en algún momento sus gentes sean menos lerd... ¡Más refinadas! Además, ¿No cree que la cubrir los caprichos de la princesa Melisenda, de forma tan incondicional, puede turbar su buen juicio, haciéndola impulsiva y caprichosa?"
Flashback_Castle_King_3 = u"Créame, Señor Pusles, que he intentado hacerla entrar en razón, pero su genio ha salido al de su abuela, que en paz descanse. Yo soy el Rey, pero los deseos de Melisenda son los deseos de la futura reina. No hay nada que se pueda hacer al respecto. Vaya con dios y tenga un buen día, estimado Señor Pusles."

# Castillo exterior

Flashback_Kidnapping_Pusles_1 = u"Si el rey Sapiensa no va a hablar con su hija, ¡tendré que hacerlo yo"
Flashback_Kidnapping_Melisenda_1 = u"¿Quién es el urón más bonito? ¡Si, Tú!" # El urón se llama Sir Frederick Von Hut
Flashback_Kidnapping_Windows_1 = u"*Chirrido de ventana abriendose*"
Flashback_Kidnapping_Melisenda_2 = u"¿Quién anda ahí?"
Flashback_Kidnapping_Pusles_2 = u"Buenas noches princesa Melisenda, permítame que me presente. Soy el señor Puzles, un apasionado de los acertijos y el té. Disculpe que aparezca esta noche de forma tan inesperada en sus aposentos, pero necesitaba hablar con usted"
Flashback_Kidnapping_Melisenda_3 = u"¡EEEK! ¡Sir Frederick, protegeme de este hombre... ¿Cabra?!"
Flashback_Kidnapping_Pusles_3 = u"No soy un hombre cabra alteza, es una másc..."
Flashback_Kidnapping_Melisenda_4 = u"¡Me da igual! ¿Qué haces en mi habitación?"
Flashback_Kidnapping_Pusles_4 = u"Como le iba diciendo, deseaba poder hablar con usted sobre el asunto de la casa de su mascota. Vera, el establecimiento donde pretende situar el hogar de su urón..."
Flashback_Kidnapping_Melisenda_5 = u"¡Sir Frederick Von Hut, plebeyo! No te encuentras ante un simple urón."
Flashback_Kidnapping_Pusles_5 = u"... El hogar de Sir Frederick Von Hut, según tengo entendido, va a estar situado en el que ahora es el único lugar de la ciudad donde su humilde servidor puede sentirse cómodo."
Flashback_Kidnapping_Melisenda_6 = u"¿Que insinuas?"
Flashback_Kidnapping_Pusles_6 = u"Sin afán de menospreciar al resto de los habitantes del reino, no he conseguido encontrar otro lugar donde se aprecien los buenos modales, el silencio y el sabor del té"
Flashback_Kidnapping_Melisenda_7 = u"Precisamente Sir Frederick Von Hut necesita un lugar tranquilo en el que descansar, y todos los demás terrenos tienen mal karma"
Flashback_Kidnapping_Pusles_7 = u"Bueno, pero usted es la princesa y futura heredera. Seguro que podría usar su posición para hallar un lugar en el que su urón..."
Flashback_Kidnapping_Melisenda_8 = u"¡Sir Frederick Von Hut!"
Flashback_Kidnapping_Pusles_8 = u"... En el que Sir Frederick Von Hut encuentre su necesitado remanso de paz"
Flashback_Kidnapping_Melisenda_9 = u"Hum... No, el lugar que he decidido es el mejor. No lo cambiaré por nada en el mundo."
Flashback_Kidnapping_Pusles_9 = u"Permitame que insista, alteza. Para mi es muy importante ese local, la dueña es amiga mia y como ya he comentado, es un lugar irremplazable en el reino. Por favor, reconsidere buscar otro lugar para... Sir Frederick Von Hut"
Flashback_Kidnapping_Melisenda_10 = u"<No> es no. Y ahora fuera de mis aposentos o llamaré a la guardia. Aunque podría haberla llamado antes..."
Flashback_Kidnapping_Pusles_10 = u"Alteza, para mi ese lugar es muy importante. Por favor, reconsidere su decisión..."
...
# guarida de Pusles Acto 1

Flashback_DarkTower1_Narrador_1 = u"2 días después"
...
# guarida de Pusles Acto 2
Flashback_DarkTower2_Melisenda_1 = u"¿Que querían Pusles? ¿Te han traido algún juego nuevo que no sea tan complicado?"
